...
object AppSystemSetManage {
     ...
     */
    var darkUI: Boolean
        get() = DataStoreHelper.readBooleanData(Dark_Mode, true)
        set(value) = DataStoreHelper.saveSyncBooleanData(Dark_Mode, value = value)
...
//        set(value) = DataStoreUtils.saveSyncBooleanData(Close_Animation, value = value)
    ...
    var darkModeFollowSystem: Boolean
        get() = DataStoreHelper.readBooleanData(Dark_Mode_FOLLOW_SYSTEM, false)
        set(value) = DataStoreHelper.saveSyncBooleanData(Dark_Mode_FOLLOW_SYSTEM, value = value)
//
